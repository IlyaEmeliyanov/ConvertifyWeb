...
const TermsConditions: FC<TermsConditionsProps> = () => {
    return (
        <section className="section">
            <i>Last updated: 15/01/2022</i>
            <br />
            <br />
            <div>
                <strong>Terms and Conditions</strong>
                <p>Welcome to conv3rtify.com!</p>
                <p>These terms and conditions outline the rules and regulations for the use of Conv3rtify's Website, located at https://conv3rtify.netlify.app/.</p>
                <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use conv3rtify.com if you do not agree to take all of the terms and conditions stated on this page.</p>
            ...
            <div>
                ...
                <p>We employ the use of cookies. By accessing conv3rtify.com, you agreed to use cookies in agreement with the Conv3rtify's Privacy Policy</p>
            ...
            <div>
                ...
                <p>Unless otherwise stated, Conv3rtify and/or its licensors own the intellectual property rights for all material on conv3rtify.com. All intellectual property rights are reserved. You may access this from conv3rtify.com for your own personal use subjected to restrictions set in these terms and conditions.</p>
